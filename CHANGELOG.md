...
### Changed
- **GLM template updated**: sonnet-tier now maps to `glm-5.3-flash[1m]` instead of mirroring `glm-5.3[1m]`. Three-tier split restored: opus → `glm-5.3[1m]`, sonnet → `glm-5.3-flash[1m]`, haiku → `glm-5-turbo`. Existing instances are migrated automatically on next launch.
...
[0.12.0]: https://github.com/hmziqrs/claude-multi/compare/v0.11.1...v0.12.0
