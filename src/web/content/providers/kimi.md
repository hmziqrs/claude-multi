...
The 256K context window covers most day-to-day development. If you regularly work with codebases larger than 200K tokens, [DeepSeek](/providers/deepseek/) or [MiniMax](/providers/minimax/) offer 1M windows.

Kimi is pay-per-token only. There is no subscription plan. If you prefer a flat monthly rate, [GLM](/providers/glm/) offers a coding plan subscription.

## Pricing details

K2.7 Code costs $0.95/MTok input (cache miss), $0.19/MTok input (cache hit), $4.00/MTok output. Check [moonshot.ai](https://moonshot.ai) for current pricing on all tiers.
...
- [MiMo](/providers/mimo/) for lower cost per token, 1M context
