...
DashScope charges per token with no minimums. Each tier has its own rate: Flash is cheapest, Next is most expensive. Check the [DashScope pricing page](https://dashscope.aliyuncs.com) for current rates.
